...
function __phonixRandomPattern(assetArr, _fadeIn, _fadeOut, _group) constructor{
	soundIDs = [];
	...
	play = function(priority, _x, _y, _z, fo_ref, fo_max, fo_factor){
		...
		var s = new __createSinglePatternStruct(group, false, soundIDs[r], fadeInTimer, fadeOutTimer, priority, [_x, _y, _z], [fo_ref, fo_max, fo_factor]);
